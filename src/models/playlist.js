...
var artists = localStorage['playlister_artists'] && JSON.parse(localStorage['playlister_artists']).map(Artist) || []
var nextTracks = []
...
var me = module.exports = {
  ...
  save: function () {
    localStorage['playlister_artists'] = JSON.stringify(artists)
  },
  ...
  getNextTrack: function (callback) {
    console.log('getNextTrack nextTracks:', nextTracks)
